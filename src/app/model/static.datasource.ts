...
[new Color('blue',false,true),new Color('black',false,true),new Color('brown',false,true),
...
[new Color("green",false,true),new Color("brown",false,true)],
[new Size('L',false,true),new Size('M',false,true),new Size('SM',false,true)],100),
new Product(3, "dress3", "dresses","assets/images/dress3.jpg", "Dresses 3(Dresses)",
[new Color('red',false,true),new Color('grey',false,true)],
[new Size('XL',false,true),new Size('XXL',false,true),new Size('XL',false,true)], 100),
